...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UserMasterId = Request.Form["UserMasterId"];
  ...
  protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        string query = " select LoginID,Password,Designation,desig_id,locations_id,page_id,reports,role_id from tblUserMaster where (LoginID=@uname or eMailID=@uname) and UserMasterId='" + txtUserMasterID.Text + "'";
            ...
            if (ds.Tables[0].Rows[0]["Password"].ToString() == txt_pass.Text)
            {
                try
                {
                    ...
                    if (_result != null)
                    {
                        ...
                        Session["Locations"] = ds.Tables[0].Rows[0]["locations_id"].ToString();
                        Session["pageAccess"] = ds.Tables[0].Rows[0]["page_id"].ToString();
                        Session["roles"] = ds.Tables[0].Rows[0]["role_id"].ToString();
                        Session["reportAccess"] = ds.Tables[0].Rows[0]["reports"].ToString();
                    }
