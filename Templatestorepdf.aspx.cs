        ...
        else if (TreeView1.CheckedNodes.Count == 1)
        {
            ...
            if (TreeView1.CheckedNodes.Count > 0 && TreeView1.CheckedNodes.Count < 2)
            {
                ...
                if (!string.IsNullOrEmpty(fullName))
                {
                    ...
                    //{
                    if (childfilename.Text.Contains("CIITMED_LIEN"))
                    {
                        string newfilename = childfilename.Text;
                        float[] xaxis = new float[] { 380f, 380f };
                        float[] yaxis = new float[] { 180f, 200f };
                    ...
                    if (childfilename.Text.Contains("Llien document"))
                    {

                        string newfilename = childfilename.Text;
                        float[] xaxis = new float[] { 0f, 90f };
                        float[] yaxis = new float[] { 0f, 308f };

                        //string imagepath = Server.MapPath("~/Sign/27082_Choi, David.jpg");
                        string imagepath = fullName.Replace("D:", "E:");
                        setPDF(pdfPath, newfilename, imagepath, xaxis, yaxis);
                        pdfPath = Server.MapPath("~/PdfForms/" + newfilename);
                    ...
                    if (childfilename.Text.Contains("ASMPC_lien document.pdf"))
                    {
                        string newfilename = childfilename.Text;
                        float[] xaxis = new float[] { 380f, 0f };
                        float[] yaxis = new float[] { 120f, 0f };
                        //string imagepath = Server.MapPath("~/Sign/4639_768.jpg");
                        string imagepath = fullName;
                        setPDF(pdfPath, newfilename, imagepath, xaxis, yaxis);
                        pdfPath = Server.MapPath("~/PdfForms/" + newfilename);
                    ...
                    if (childfilename.Text.Contains("NF packet_e.pdf"))
                    {
                     ...
                     if (childfilename.Text.Contains("SURGICORE BS.pdf"))
                    {
                        string newfilename = childfilename.Text;
                        float[] xaxis = new float[] { 350f };
                        float[] yaxis = new float[] { 73f };
                        //string imagepath = Server.MapPath("~/Sign/4639_768.jpg");
                        string imagepath = fullName;
                        setPDF(pdfPath, newfilename, imagepath, xaxis, yaxis);
                        pdfPath = Server.MapPath("~/PdfForms/" + newfilename);
                    ...
                    //{
                        //string newfilename = childfilename.Text;
                        //float[] xaxis = new float[] { 0f, 350f, 290f, 0f, 110f };
                        //float[] yaxis = new float[] { 0f, 326f, 393f, 0f, 88f };
                        ////string imagepath = Server.MapPath("~/Sign/4639_768.jpg");
                        //string imagepath = fullName;
                        //setPDF(pdfPath, newfilename, imagepath, xaxis, yaxis);
                        //pdfPath = Server.MapPath("~/PdfForms/" + newfilename);
                    ...
                    {
                        string newfilename = childfilename.Text;
                        float[] xaxis = new float[] { 0f, 350f, 0f, 0f, 120f, 0f, 355f, 0f, 290f, 0f, 110f };
                        float[] yaxis = new float[] { 0f, 326f, 0f, 0f, 460f, 0f, 230f, 0f, 393f, 0f, 88f };
                        //string imagepath = Server.MapPath("~/Sign/4639_768.jpg");
                        string imagepath = fullName;
                        setPDF(pdfPath, newfilename, imagepath, xaxis, yaxis);
                        pdfPath = Server.MapPath("~/PdfForms/" + newfilename);
                    ...
                    {
                        string newfilename = childfilename.Text;
                        float[] xaxis = new float[] { 0f, 301f, 0f, 38f, 38f };
                        float[] yaxis = new float[] { 0f, 366f, 0f, 183f, 72f };
                        //string imagepath = Server.MapPath("~/Sign/4639_768.jpg");
                        string imagepath = fullName;
                        setPDF(pdfPath, newfilename, imagepath, xaxis, yaxis);
                        pdfPath = Server.MapPath("~/PdfForms/" + newfilename);
                ...
                if ((Convert.ToString(Session["filename"]).Equals("NF packet.pdf") ||
                 Convert.ToString(Session["filename"]).Equals("CMSC.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-ALL City-LKn1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-ALL City-LSh1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-ALL City-RKn1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-ALL City-RSh1.pdf") ||
                 Convert.ToString(Session["filename"]).Equals("CPM-LKn1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-LSh1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-RKn1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-RSh1.pdf") ||
                 Convert.ToString(Session["filename"]).Equals("Llien document.pdf") ||
                 Convert.ToString(Session["filename"]).Contains("CIITMED_LIEN") ||
                 Convert.ToString(Session["filename"]).Equals("WC Pkt.pdf"))
                  && !string.IsNullOrEmpty(txtproc_code_date.Text))
                {
                ...
                formFieldMap["txt_Diagnosis"] = "S/P"+ " " + txtProcedureCode.Text;
                formFieldMap["txt_Diagnosis_office_visit"] = "Left Shoulder Pain, Right Shoulder Pain, Left Knee Pain, Right Knee Pain";
                ...
                formFieldMap["txt_EmpFax"] = Convert.ToString(Session["EmpFax"]);
                ...
                formFieldMap["txt_duration"] = " 4-6 Weeks ";
                formFieldMap["txt_duration1"] = " 2-4 Weeks ";
                if (Session["sex"] != null)
                ...
                if (Convert.ToString(Session["filename"]).Equals("emergency form.pdf"))
                {
                    string pro_code = Convert.ToString(txtProcedureCode.Text);
                    if (!string.IsNullOrWhiteSpace(pro_code))
                    {
                        //open the tender xml file  
                        XmlTextReader xmlreader = null;
                        xmlreader = new XmlTextReader(Server.MapPath("~/XML/emergency.xml"));
                        ...
                        if (ds2.Tables.Count != 0)
                        {
                            ...
                            {
                                if (Convert.ToString(pro_code.Replace(' ', '_') + cnt).ToLower().Contains(column.ColumnName.ToLower()))
                                {
                                    string value = Convert.ToString(ds2.Tables[0].Rows[0][Convert.ToString(column.ColumnName)]);
                                    ...
                                    if (cnt.Equals(1))
                                    {
                                        ...
                                        if (Session["doa"] != null)
                                            if (!string.IsNullOrWhiteSpace(Session["doa"].ToString()))
                                            {
                                                MONTH = Convert.ToString(GetMonthDifference(Convert.ToDateTime(Session["doa"].ToString()), DateTime.Now));
                                            }
                                        value = value.Replace("_", " " + MONTH + " ");
                                    }

                                    string fieldname = "field" + cnt;
                                    formFieldMap[Convert.ToString(fieldname)] = value;
                                    cnt++;
                                }
                            }
                        }
                ...
                if (Convert.ToString(Session["filename"]).Equals("CPM-RSh.pdf") || Convert.ToString(Session["filename"]).Equals("CPM-LSh.pdf") || Convert.ToString(Session["filename"]).Equals("CPM-RKn.pdf") || Convert.ToString(Session["filename"]).Equals("CPM-LKn.pdf") || Convert.ToString(Session["filename"]).Equals("MG2.pdf"))
                {
                    //open the tender xml file  
                    XmlTextReader xmlreader = null;
                    if (Convert.ToString(Session["filename"]).Equals("CPM-RSh.pdf"))
                    { xmlreader = new XmlTextReader(Server.MapPath("~/XML/CPM-RSh.xml")); }
                    else if (Convert.ToString(Session["filename"]).Equals("CPM-LSh.pdf"))
                    { xmlreader = new XmlTextReader(Server.MapPath("~/XML/CPM-LSh.xml")); }
                    else if (Convert.ToString(Session["filename"]).Equals("CPM-RKn.pdf"))
                    { xmlreader = new XmlTextReader(Server.MapPath("~/XML/CPM-RKn.xml")); }
                    else if (Convert.ToString(Session["filename"]).Equals("CPM-LKn.pdf"))
                    { xmlreader = new XmlTextReader(Server.MapPath("~/XML/CPM-LKn.xml")); }
                    else if (Convert.ToString(Session["filename"]).Equals("MG2.pdf"))
                    { xmlreader = new XmlTextReader(Server.MapPath("~/XML/MG2.xml")); }
                    ...
                    if (ds1.Tables.Count != 0)
                    {
                        ...
                        {
                            formFieldMap[Convert.ToString(column.ColumnName)] = Convert.ToString(ds1.Tables[0].Rows[0][Convert.ToString(column.ColumnName)]);
                        }
                    }
                }
        ...
        else if (TreeView1.CheckedNodes.Count == 1)
        {
            ...
            if (TreeView1.CheckedNodes.Count > 0 && TreeView1.CheckedNodes.Count < 2)
            {
                ...
                if ((Convert.ToString(Session["filename"]).Equals("NF packet.pdf") ||
                 ...
                 Convert.ToString(Session["filename"]).Equals("CPM-LSh1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-RKn1.pdf") || 
                 Convert.ToString(Session["filename"]).Equals("CPM-RSh1.pdf") )&& !string.IsNullOrEmpty(txtproc_code_date.Text))
                {
                    formFieldMap["txt_date"] = txtproc_code_date.Text;
                }
                else
    ...
    public void bindEditData(string PatientIEid)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (string.IsNullOrWhiteSpace(ds.Tables[0].Rows[0]["EmpFax"].ToString()))
                {
                    Session["EmpFax"] = " ";
                }
                else
                {
                    Session["EmpFax"] = ds.Tables[0].Rows[0]["EmpFax"].ToString();
                }
