...
public partial class PatientIntakeList : System.Web.UI.Page
{
    ...
    protected void lnkprint_Click(object sender, EventArgs e)
    {
        ...
        string gentel = sex == "male" ? "gentelman" : "gentlewoman";

        string doa = CommonConvert.DateFormat(ds.Tables[0].Rows[0]["DOA"].ToString());
        string age = calculateAge(Convert.ToDateTime(ds.Tables[0].Rows[0]["DOB"].ToString())).ToString();
        ...
        string printpage1str = printPage1(lnk.CommandArgument, age, sex, doa, gender,gentel);
        ...
        ////str = str.Replace("#generaltext", ViewState["generalText"].ToString() + CommonConvert.DateFormat(ds.Tables[0].Rows[0]["DOA"].ToString()) + ".<br/><br/>");

        Int64 idId = Convert.ToInt64(lnk.CommandArgument);
        string strBodypart = getBodyParts(idId);

        str = str.Replace("#present_complaints", "The patient is here for an orthopedic evaluation of " + strBodypart + ".<br/><br/>");

        str = str.Replace("#bodypart", strBodypart);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#address", ds.Tables[0].Rows[0]["NameOfPractice"].ToString()+"<br/>"+ ds.Tables[0].Rows[0]["Address"].ToString() + "<br/>" + ds.Tables[0].Rows[0]["City"].ToString() + ", " + ds.Tables[0].Rows[0]["State"].ToString() + " " + ds.Tables[0].Rows[0]["Zip"].ToString());
        }
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#pastmedicalhistory", string.IsNullOrEmpty(page1["PMH"]) ? "" : "<b><u>PAST MEDICAL HISTORY</u>: </b><br/>" + page1["txt_PMH"].TrimEnd('.') + ".<br /><br/>");
            str = str.Replace("#pastsurgicalhistory", string.IsNullOrEmpty(page1["PSH"]) ? "" : "<b><u>PAST SURGICAL HISTORY</u>: </b><br/>" + page1["PSH"].TrimEnd('.') + ".<br/><br/>");
            str = str.Replace("#pastmedications", string.IsNullOrEmpty(page1["Medication"]) ? "" : "<b><u>CURRENT MEDICATIONS</u>: </b><br/>" + page1["Medication"].TrimEnd('.') + ".<br/><br/>");
            str = str.Replace("#allergies", string.IsNullOrEmpty(page1["Allergies"]) ? "" : "<b><u>ALLERGIES</u>: </b><br/>" + page1["Allergies"].TrimEnd('.').ToUpper() + ".<br/><br/>");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#socialhistory", "<b><u>SOCIAL HISTORY</u>:<br/> </b>" + strstatus.TrimEnd('.').Replace(" .", "") + "<br/><br/>");
        }
        else
        {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (page1_accident.ContainsKey("txt_vital"))
            {
                if (!string.IsNullOrEmpty(page1_accident["txt_vital"]))
                    str = str.Replace("#vital", page1_accident["txt_vital"].Trim());
            }
            ...
            str = str.Replace("#work_status", string.IsNullOrEmpty(work_status) ? "" : "<b><u>WORK HISTORY</u>: </b>" + work_status + "<br/><br/>");
        ...
        //treatment priting
        query = ("Select TreatMentDetails,TreatMentDelimit from tblbpOtherPart WHERE PatientIE_ID=" + lnk.CommandArgument + "");
        ds = db.selectData(query);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            treatment = this.getTreatmentValues(ds.Tables[0].Rows[0]["TreatMentDelimit"].ToString());
        }
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(strExceptions))
                str = str.Replace("#reflexexam", "<b><u>REFLEX EXAMINATION</u>: </b>" + strExceptions + "<br/><br/>");
            else
            ...
            if (!string.IsNullOrEmpty(senexam) && !string.IsNullOrEmpty(strRE))
                str = str.Replace("#sensoryexam", "<b><u>SENSORY EXAMINATION</u>: </b>" + strRE + ". It with the following exceptions: " + senexam + ".<br/><br/>");
            else if (string.IsNullOrEmpty(strRE))
                str = str.Replace("#sensoryexam", "<b><u>SENSORY EXAMINATION</u>: </b>" + strRE + ".<br/><br/>");
            else
            ...
            if (!string.IsNullOrEmpty(strExceptions))
                str = str.Replace("#motorexam", "<b><u>MOTOR EXAMINATION</u>: </b>" + strExceptions.TrimStart(',').TrimEnd('.') + ".<br/><br/>");
            else
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#medications", string.IsNullOrEmpty(strMedi) ? "" : "<b><u>CURRENT MEDICATIONS</u>: </b><br/>" + strMedi + "<br/><br/>");
        }
        else
        {
        ...
        str = str.Replace("#plan", string.IsNullOrEmpty(strPlan) ? "" : "<br/><br/>" + strPlan + "<br/><br/>");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["CCvalue"].ToString()))
            {
                Dictionary<string, string> page1 = new PrintDocumentHelper().getPage1String(ds.Tables[0].Rows[0]["CCvalue"].ToString());
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                string romstr = this.getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["LeftROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "left", "IE");
                if (!string.IsNullOrEmpty(romstr))
            ...
            shoulderPE = shoulderPE.Replace("#rightshouldertitle", "<b>RIGHT SHOULDER: </b> Examination ");

            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["RightROM"].ToString()))
            {
                string romstr = this.getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["RightROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "right", "IE");
                if (!string.IsNullOrEmpty(romstr))
            ...
            shoulderPE = shoulderPE.Replace("#leftshouldertitle", "<b>LEFT SHOULDER: </b>Examination ");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            kneePE = kneePE.Replace("#rightkneetitle", "<b>RIGHT KNEE: </b>Examination ");
            ...
            kneePE = kneePE.Replace("#leftkneetitle", "<b>LEFT KNEE: </b>Examination ");
   ...
   public string printPage1(string patientIE_ID, string age = "", string gender = "", string doa = "", string sex = "",string gentle="")
    {
        ...
        string str = "";
        Dictionary<string, string> page1 = new PrintDocumentHelper().getPage1String(ds.Tables[0].Rows[0]["historyHTML"].ToString());
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = "The patient is a " + age + "-year-old " + gentle.ToLower() + ", ";

            if (page1["chkh1"] == "true")
            {
                str = str + "who was the #change1 of a vehicle that was involved in a  #change2 accident on #doa. ";

                if (!string.IsNullOrEmpty(page1["txt_chkh1_desc"]))
                    str = str.Replace("#change1", page1["txt_chkh1_desc"].ToString());

                if (!string.IsNullOrEmpty(page1["txt_chkh2_desc"]))
                    str = str.Replace("#change2", page1["txt_chkh2_desc"].ToString());
            }

            if (page1["chkh2"] == "true")
            {
                str = str + "who was involved in a work related accident on #doa. ";
            }
            ...
            if (!string.IsNullOrEmpty(strBodypart))
                str = str  + "The patient sustained multiple skeletal injuries including injury to " + strBodypart.TrimStart(',') + ". ";

            if (page1["chkh3"] == "true")
            {
                str = str + "The patient was taken on an emergent basis to #hospital Hospital where " + sex.ToLower() + " was treated and released. ";

                if (!string.IsNullOrEmpty(page1["txt_chk_hospital"]))
                    str = str.Replace("#hospital", page1["txt_chk_hospital"].ToString());
                else
                    str = str.Replace("#hospital", "");
            }
            else
            {
                str = str + "The patient did not go to any hospital that same day. ";
            }

            if (page1.ContainsKey("txtWeek"))
            {
                if (!string.IsNullOrEmpty(page1["txtWeek"]))
                    str = str + "The patient has been undergoing physical therapy for the past " + page1["txtWeek"] + ". ";
            }

            str = str + "My evaluation is limited to " + strBodypart + " injury sustained in the accident of " + doa + ".";
   ...
   new System.Web.UI.HtmlControls.HtmlGenericControl("DIV");
        ...
        if (dsPOC != null && dsPOC.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < dsPOC.Tables[0].Rows.Count; i++)
            {
                if (!string.IsNullOrEmpty(dsPOC.Tables[0].Rows[i]["Heading"].ToString()))
                {
                    ...
                    //else
                   // strPoc = strPoc + "<b style='text-transform:uppercase'>" + dsPOC.Tables[0].Rows[i]["Heading"].ToString().TrimEnd(':') + ": </b>" + dsPOC.Tables[0].Rows[i]["PDesc"].ToString() + "<br/><br/>";
                    strPoc = strPoc  + dsPOC.Tables[0].Rows[i]["PDesc"].ToString() + "<br/><br/>";
                }
            }
        }
        return strPoc;
    ...
    private string getTreatmentValues(string val)
    {
        string _str = "";
        if (!string.IsNullOrEmpty(val))
        {
