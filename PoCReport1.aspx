<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="PoCReport1.aspx.cs" Inherits="PoCReport1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="Server">
    ...
    <div class="main-content-inner">
        <div class="page-content">
            ...
            <asp:TextBox ID="txtSearchFromdate1"  Style="display:none"  runat="server" ></asp:TextBox>
            <div class="clearfix"></div>
