...
<asp:Content ID="Content1" style="margin-top: 90px;" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function checkDuplicate(fName, lName, mName, doa) {

            var msg = "This patient " + fName + " " + mName + " " + lName + " is already exist for DOA on " + doa + ". Please use Case-1 for New Entry !";
            ...
            <div class="form-horizontal">
                <div class="control-group span12">
                    ...
                    <div class="control-group span6">
                        ...
                        <div class="controls">
                            <asp:TextBox ID="txtImpNotes" style="width: 100%;" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
