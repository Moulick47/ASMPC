...
public partial class SurgeryReport : System.Web.UI.Page
{
    ...
    protected void lkExportToexcel_Click(object sender, EventArgs e)
    {
        ...
        {
            wb.Worksheets.Add(dt, "SurgeryReport");
            Response.Clear();
            Response.Buffer = true;
            Response.Charset = "";
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=SurgeryReport"+ddlDates.SelectedValue+".xlsx");
    ...
    //private void BindAvailableDates()
    //{
    //    DataSet ds = new DataSet();
