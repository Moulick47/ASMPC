...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="Server">
 ...
 <fieldset>
                                            <legend>Upload Document(Zip)</legend>
                                            <table width="100%">
                                                <tr>
                                                    <td>Select Folder</td>
                                                    <td>
                                                        <asp:FileUpload runat="server" ID="fupZip" /></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <asp:Button runat="server" ID="btnupload_zip" Text="Upload" OnClick="btnupload_zip_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
